    ...
    render() {
        return (
            <div>
                ...
                <h3 style={{ color: "black", textAlign: "center" }}>Approved</h3>
                    ...
                    {this.state.filtered.map((elem) => {
                        return <div className="card" key={Math.random(36)}>
                            ...
                            <div className="card-body">
                                ...
                                <br />
                                <button className="btn btn-primary" style={{ float: "right", marginTop: "10px" }} onClick={this.approve.bind(this, elem[0].uid, elem[0].pushRestaurant, elem[0].pushUser)}>Delivered</button>
                            </div>
                        </div>
                    })}
